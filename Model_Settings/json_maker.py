...
def write(runName):
    ...
    ####
    elif runName == '181114rgmS5': # using 1800912c2new2 
        dataLocal['classificationModel'] = True
        _181114rgmS5(reCompile, trainLogDirBase, testLogDirBase, runName, dataLocal)
    ####
    elif runName == 'incResNetV2': # 
        dataLocal['classificationModel'] = True
        _incResNetV2(reCompile, trainLogDirBase, testLogDirBase, runName, dataLocal)
    ####
    else:
...
def _181114rgmS5(reCompile, trainLogDirBase, testLogDirBase, runName, data):
    if reCompile:
        data['modelName'] = 'cnn_6lfS5'
...
def _incResNetV2(reCompile, trainLogDirBase, testLogDirBase, runName, data):
    if reCompile:
        data['modelName'] = 'incResNetV2'
