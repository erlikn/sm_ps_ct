...
from nets.erlik import optimizer_params as optimizer_params
from nets.erlik import loss_base as loss_base
...
def conv_fire_inception_module_l2reg(name, prevLayerOut, prevLayerDim, fireDims, wd=None, **kwargs):
    if (fireDims.get('cnnFC')):
        fireOut1, prevExpandDim, l2regTemp = conv_fire_module_l2regul(name+'_inc_1x1_0', prevLayerOut, prevLayerDim, {'cnn1x1': prevLayerDim}, wd, stride=[1,1,1,1], **kwargs)
        l2reg = l2regTemp
        fireOut2, prevExpandDim, l2regTemp = conv_fire_module_l2regul(name+'_inc_3x3_1', fireOut1, prevExpandDim, {'cnn3x3': prevExpandDim}, wd, stride=[1,2,2,1], padding = 'VALID', **kwargs)
        l2reg += l2regTemp
        fireOut3, prevExpandDim, l2regTemp = conv_fire_module_l2regul(name+'_inc_3x3_2', fireOut2, prevExpandDim, {'cnn3x3': prevExpandDim}, wd, stride=[1,2,2,1], padding = 'VALID', **kwargs)
        l2reg += l2regTemp
        fireOut, prevExpandDim, l2regTemp = conv_fire_module_l2regul(name+'_inc_1x3_3', fireOut3, prevExpandDim, {'cnn1x3': prevExpandDim}, wd, stride=[1,1,2,1], **kwargs)
        l2reg += l2regTemp
    ...
    return ['convFC_inc_1x1_0', 'convFC_inc_3x3_1', 'convFC_inc_3x3_2'], [fireOut1, fireOut2, fireOut3], prevExpandDim, l2reg
